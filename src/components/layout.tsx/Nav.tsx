...
// import cart from "../../public/svg/c.svg";
...
const Nav: React.FC = () => {
  ...
  return (
    <div className="fixed top-0 left-0 z-10 w-full navbar shadow-lg light:bg-white dark:bg-neutral text-neutral-content ">
              ...
              >
                ...
                <g id="SVGRepo_iconCarrier">
                  <path
                    ...
                    fill={theme === "dark" ? "grayColor" : "#0F0F0F"}
                  ></path>
                </g>
              </svg>
